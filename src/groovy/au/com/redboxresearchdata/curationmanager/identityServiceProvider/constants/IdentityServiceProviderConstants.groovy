package au.com.redboxresearchdata.curationmanager.identityServiceProvider.constants
...
class IdentityServiceProviderConstants {
	...
	static final String IDENTITY_PROVIDER_SERVICE_TEMPLATE_MISSING = "identityService.local.template.missing";
